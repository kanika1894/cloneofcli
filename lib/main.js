...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        */
//         let relative_path = process.env.GITHUB_ENV.slice(len(TEMP_DIRECTORY));
//         let container_env = CONTAINER_TEMP_DIRECTORY + relative_path;
        ...
        command += `-e GITHUB_ENV=${CONTAINER_TEMP_DIRECTORY/process.env.GITHUB_ENV.substr(TEMP_DIRECTORY.length)} `;
        // 
