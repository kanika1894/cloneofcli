...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        */
//         let relative_path = ${process.env.GITHUB_ENV}.substr(${utils_1.TEMP_DIRECTORY}.length);
//         let container_env = ${CONTAINER_TEMP_DIRECTORY}.concat(${relative_path});
        ...
        command += ` echo "${process.env.GITHUB_ENV:0:4}" ` ;
//         command += `-e GITHUB_ENV=${CONTAINER_TEMP_DIRECTORY}/${${process.env.GITHUB_ENV}:0:4} `;
